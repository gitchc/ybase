...
public class SnowID {
    ...
    public SnowID(long workerId, long dataCenterId) {
        ...
        log.info(String.format("worker starting. timestamp left shift = {%d}, dataCenter id bits = {%d}, worker id bits = {%d}, sequence bits = {%d}, workerid = {%d}, dataCenterId = {%d}",
    ...
    private static SnowID idWorker;

    static {
        idWorker = new SnowID(getWorkId(), getDataCenterId());
    }
