...
//        List<String> data2 = data1.stream().sorted(c2).collect(Collectors.toList());
//        System.out.println("stream C2 sorted data: " + (System.currentTimeMillis() - tim3));
       /* for (Member datum : data) {
            System.out.println(datum.getName()+":"+datum.getPosition());
        }*/
        System.out.println(data1.get(0));
       /* Long tim2 = System.currentTimeMillis();
        data.sort(c2);
        System.out.println("c2 sorted data: " + (System.currentTimeMillis() - tim1));
        System.out.println(data.get(1).getPosition());*/
    }
